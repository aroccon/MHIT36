...
if (fieldn .eq. 1) then
  write(namefile,'(a,i8.8,a)') './input/u_',t,'.dat'
  call mpi_file_open(MPI_COMM_WORLD,namefile,mpi_mode_rdonly,mpi_info_null,f_handle,ierr)
  call mpi_type_create_subarray(3,g_size,p_size,fstart,mpi_order_fortran,mpi_double_precision,ftype,ierr)
  call mpi_type_commit(ftype,ierr)
  call mpi_file_set_view(f_handle,offset,mpi_double_precision,ftype,'native',mpi_info_null,ierr)
  call mpi_file_write_all(f_handle,in,p_size(1)*p_size(2)*p_size(3),mpi_double_precision,mpi_status_ignore,ierr)
  call mpi_file_close(f_handle,ierr)
...
if (fieldn .eq. 2) then
  write(namefile,'(a,i8.8,a)') './input/v_',t,'.dat'
  call mpi_file_open(MPI_COMM_WORLD,namefile,mpi_mode_rdonly,mpi_info_null,f_handle,ierr)
  call mpi_type_create_subarray(3,g_size,p_size,fstart,mpi_order_fortran,mpi_double_precision,ftype,ierr)
  call mpi_type_commit(ftype,ierr)
  call mpi_file_set_view(f_handle,offset,mpi_double_precision,ftype,'native',mpi_info_null,ierr)
...
if (fieldn .eq. 3) then
  write(namefile,'(a,i8.8,a)') './input/w_',t,'.dat'
  call mpi_file_open(MPI_COMM_WORLD,namefile,mpi_mode_rdonly,mpi_info_null,f_handle,ierr)
  call mpi_type_create_subarray(3,g_size,p_size,fstart,mpi_order_fortran,mpi_double_precision,ftype,ierr)
  call mpi_type_commit(ftype,ierr)
  call mpi_file_set_view(f_handle,offset,mpi_double_precision,ftype,'native',mpi_info_null,ierr)
...
if (fieldn .eq. 4) then
  write(namefile,'(a,i8.8,a)') './input/p_',t,'.dat'
  call mpi_file_open(MPI_COMM_WORLD,namefile,mpi_mode_rdonly,mpi_info_null,f_handle,ierr)
  call mpi_type_create_subarray(3,g_size,p_size,fstart,mpi_order_fortran,mpi_double_precision,ftype,ierr)
  call mpi_type_commit(ftype,ierr)
  call mpi_file_set_view(f_handle,offset,mpi_double_precision,ftype,'native',mpi_info_null,ierr)
...
if (fieldn .eq. 5) then
  write(namefile,'(a,i8.8,a)') './input/phi_',t,'.dat'
  call mpi_file_open(MPI_COMM_WORLD,namefile,mpi_mode_rdonly,mpi_info_null,f_handle,ierr)
  call mpi_type_create_subarray(3,g_size,p_size,fstart,mpi_order_fortran,mpi_double_precision,ftype,ierr)
  call mpi_type_commit(ftype,ierr)
  call mpi_file_set_view(f_handle,offset,mpi_double_precision,ftype,'native',mpi_info_null,ierr)
